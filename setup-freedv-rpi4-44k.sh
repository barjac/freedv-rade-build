...
echo "[1/5] Configuring PipeWire for 44100 Hz..."
...
echo "[4/5] Updating FreeDV sample rates to 44100..."
...
if [ -f "$main_sinks" ]; then
    sudo sed -i 's/rate=48000/rate=44100/' "$main_sinks"
    echo "    Updated null sink rate to 44100 in $main_sinks"
else
